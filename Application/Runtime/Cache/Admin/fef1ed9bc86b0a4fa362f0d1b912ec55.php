...
<html lang="en">
	<head>
		...
		<!-- <link rel="stylesheet" href="/Public/admin/css/googlefont.css" /> -->
				...
				<div class="sidebar" id="sidebar">
					...
					<ul class="nav nav-list">
						...
						<li>
							...
							<ul class="submenu">
								<li>
									<a href="/index.php/Admin/Setting/siteset">
						...
						<li>
							...
							<ul class="submenu">
								<li>
									<a href="/index.php/Admin/Users/search">
										<i class="icon-double-angle-right"></i>
										搜索用户
									</a>
								</li>
								...
								<li class="admin">
									...
									<ul class="submenu">
										...
										<li class="group">
											<a href="/index.php/Admin/Admin/group">
												<i class="icon-leaf"></i>
												角色管理
											</a>
										</li>
						...
						<li>
							<a href="#" class="dropdown-toggle">
								<i class="icon-cog"></i>
								<span class="menu-text"> 过滤词设置 </span>
							...
							<ul class="submenu">
								<li>
									<a href="/index.php/Admin/Words/words">
										<i class="icon-double-angle-right"></i>
										过滤词管理
									</a>
								</li>
						...
						<li>
							<a href="#" class="dropdown-toggle">
								<i class="icon-cog"></i>
								<span class="menu-text"> 友情链接设置 </span>
							...
							<ul class="submenu">
								<li>
									<a href="/index.php/Admin/Friend/lists">
										<i class="icon-double-angle-right"></i>
										友情链接管理
									</a>
								</li>
						...
						<li>
							...
							<ul class="submenu">
								<li>
									<a href="/index.php/Admin/Database/dump">
										<i class="icon-double-angle-right"></i>
										数据库备份
									</a>
								</li>
								<li>
									<a href="/index.php/Admin/Database/import">
										<i class="icon-double-angle-right"></i>
										数据库还原
									</a>
								</li>
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							<li>
								...
								<a href="/index.php/Admin/Index">首页</a>
							</li>
    ...
    <div class="col-xs-12">
        <form action="/index.php/Admin/Setting/sitesave" class="form-horizontal" method="post" role="form">
            <div class="form-group">
                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 网站名称: </label>

                <div class="col-sm-9">
                    <input type="text" id="form-field-1" value="<?php echo ($title); ?>" name="title" class="col-xs-10 col-sm-5" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" id="form-field-1" value="<?php echo ($icpno); ?>" name="icpno" class="col-xs-10 col-sm-5" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" id="form-field-1" value="<?php echo ($keywords); ?>" name="keywords" class="col-xs-10 col-sm-5" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" id="form-field-1" value="<?php echo ($description); ?>" name="description" class="col-xs-10 col-sm-5" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" id="form-field-1" value="<?php echo ($contact); ?>" name="contact" class="col-xs-10 col-sm-5" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <button class="btn btn-warning btn-lg">保存设置</button>
                </div>
            </div>
        </form>
        <div class="hr hr-24"></div>
        ...
        <form action="/index.php/Admin/Setting/replogo" class="form-horizontal" method="post" role="form" enctype="multipart/form-data" >
            <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> <img style="border:1px solid #ccc" src="/Public/home/uploads/static/<?php echo ($logo); ?>" alt="" width="124" height="35" /> </label>

                    <div class="col-sm-9">
                        <input type="file" id="form-field-1" name="logo" class="col-xs-10 col-sm-5" />
                    </div>
            </div>
            <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> </label>
                    <div class="col-sm-9">
                        <button class="btn btn-success">更换图片</button>
                    </div>
            </div>
        </form>
    </div>
...
<![endif]-->
    ...
    <script>
        ...
        $(".nav-list>li:eq(1)").addClass('open');
    </script>
